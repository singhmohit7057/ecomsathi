      ...
      // ── /tools/image — Image Tools hub + individual tools ──────
      {
        ...
        children: [
          ...
          },
          {
            ...
            handle: { toolName: 'Background Remover', category: 'Image Tools', description: 'Remove backgrounds from product images automatically using AI.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'crop',
            element: <S><CropImage /></S>,
            handle: { toolName: 'Crop Image', category: 'Image Tools', description: 'Drag-and-drop crop with aspect ratio presets and rotation support.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'resize',
            element: <S><ResizeImage /></S>,
            handle: { toolName: 'Resize Image', category: 'Image Tools', description: 'Resize by custom dimensions, percentage, or marketplace presets.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'compress',
            element: <S><CompressImage /></S>,
            handle: { toolName: 'Compress Image', category: 'Image Tools', description: 'Reduce file size with quality control and optional target size input.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'converter',
            element: <S><ImageConverter /></S>,
            handle: { toolName: 'Image Converter', category: 'Image Tools', description: 'Convert between JPG and PNG formats. Batch conversion supported.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'enhance',
            element: <S><EnhanceImage /></S>,
            handle: { toolName: 'Image Enhancer', category: 'Image Tools', description: 'Sharpen, boost contrast and improve product image quality in your browser.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'webp',
            element: <S><WEBPConverter /></S>,
            handle: { toolName: 'WEBP Converter', category: 'Image Tools', description: 'Convert between WEBP and PNG/JPG formats in both directions.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'watermark',
            element: <S><ImageWatermark /></S>,
            handle: { toolName: 'Image Watermark', category: 'Image Tools', description: 'Add text or logo watermarks with opacity, size, and position control.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'product-optimizer',
            element: <S><ProductOptimizer /></S>,
            handle: { toolName: 'Product Image Optimizer', category: 'Image Tools', description: 'Optimize product images for Amazon, Flipkart, Myntra, Meesho, and more.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'white-background',
            element: <S><WhiteBackground /></S>,
            handle: { toolName: 'White Background', category: 'Image Tools', description: 'Replace product photo backgrounds with white for marketplace compliance.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'square',
            element: <S><SquareImageCreator /></S>,
            handle: { toolName: 'Square Image Creator', category: 'Image Tools', description: 'Add padding to make any image perfectly square. Pick position and fill color.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
          {
            path: 'image-to-pdf',
            element: <S><ImageToPDF /></S>,
            handle: { toolName: 'Image to PDF', category: 'Image Tools', description: 'Combine JPG, PNG, or WEBP images into a single PDF. Drag to reorder.', crumbs: [{ label: 'Image Tools', to: '/tools/image' }] },
          },
        ],
      },
        ...
        children: [
          {
            ...
            handle: { tool: 'Video Tools', category: 'Video Tools' },
          },
          {
            path: 'to-gif',
            element: <S><VideoToGIF /></S>,
            handle: { tool: 'Video to GIF', category: 'Video Tools', description: 'Convert video clips to animated GIF for ecommerce listings.' },
          },
          {
            path: 'frame-extractor',
            element: <S><FrameExtractor /></S>,
            handle: { tool: 'Frame Extractor', category: 'Video Tools', description: 'Extract individual frames from any video as JPEG images.' },
          },
          {
            path: 'compress',
            element: <S><CompressVideo /></S>,
            handle: { tool: 'Compress Video', category: 'Video Tools', description: 'Reduce video file size for marketplace uploads and social media.' },
          },
          {
            path: 'resize',
            element: <S><ResizeVideo /></S>,
            handle: { tool: 'Resize Video', category: 'Video Tools', description: 'Change video resolution for marketplace requirements.' },
          },
          {
            path: 'converter',
            element: <S><VideoConverter /></S>,
            handle: { tool: 'Video Converter', category: 'Video Tools', description: 'Convert between MP4, MOV, AVI, WEBM, MKV formats.' },
          },
          {
            path: 'thumbnail-generator',
            element: <S><ThumbnailGenerator /></S>,
            handle: { tool: 'Thumbnail Generator', category: 'Video Tools', description: 'Extract the perfect thumbnail from your product video.' },
          },
        ],
      },
